...
".stat-card,.feature-card,.wish-card,.gallery-grid img,.message-box,.quote-box"
...
alert("🎉 இனிய பிறந்தநாள் நல்வாழ்த்துக்கள் அப்பா ❤️");
...
video.style.transform=`translateY(${scroll*0.2}px)`;
...
box.innerHTML="🎉 Happy Birthday Appa ❤️";
...
topBtn.style.background="#ff4b91";
